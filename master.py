...
# Example: reading logs generated by agents
logs = [
    "login failed",
    "login failed",
    "login failed",
...
failed_logins = logs.count("login failed")

if failed_logins >= 3:

    st.markdown("### 2️⃣ Dashboard shows")
...
""")
    ...
    st.markdown("### 3️⃣ System responds")
...
""")
    ...
    st.markdown("### 4️⃣ AI explains")

    st.code("""
This pattern matches brute force login attack behaviour.
""")
